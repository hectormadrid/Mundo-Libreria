...
<body class="bg-gray-100">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="nav-links space-y-2">
            ...
            <a href="pedidos.php" class="flex items-center bg-blue-700 px-2 py-1 rounded"><i class="fas fa-box text-white mr-2"></i><span class="text-white">Pedidos</span></a>
            <a href="usuarios.php" class="flex items-center"><i class="fas fa-users text-white mr-2"></i><span class="text-white">Usuarios</span></a>
        </div>
