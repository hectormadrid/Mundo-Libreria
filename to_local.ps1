# to_local.ps1
# Este script cambia las rutas de configuración de servidor a configuración local.
...
Write-Host "Cambiando rutas a configuración local..."
...
Replace-FileContent "js/Admin/agregarProductos.js" "const response = await fetch(`/pages/Admin/obtener_familias_por_categoria.php?categoria_id=${categoriaId}`);" "const response = await fetch(`obtener_familias_por_categoria.php?categoria_id=${categoriaId}`);"
Replace-FileContent "js/Admin/agregarProductos.js" "      const response = await fetch(""/pages/Admin/agregar_productos.php"", {" "      const response = await fetch(""agregar_productos.php"", {"
...
'@
Replace-FileContent "js/Admin/editarProductos.js" "const response = await fetch(`/pages/Admin/obtener_familias_por_categoria.php?categoria_id=${categoryId}`);" "const response = await fetch(`obtener_familias_por_categoria.php?categoria_id=${categoryId}`);"
Replace-FileContent "js/Admin/editarProductos.js" "const response = await fetch(""/pages/Admin/editar_productos.php"", {" "const response = await fetch(""editar_productos.php"", {"

# js/Admin/gestionAdmins.js
Write-Host "Procesando js/Admin/gestionAdmins.js..."
Replace-FileContent "js/Admin/gestionAdmins.js" "url: '/pages/Admin/obtener_admins.php', // Endpoint para obtener admins" "url: 'obtener_admins.php', // Endpoint para obtener admins"
Replace-FileContent "js/Admin/gestionAdmins.js" "fetch('/pages/Admin/crear_administrador.php', {" "fetch('crear_administrador.php', {"
Replace-FileContent "js/Admin/gestionAdmins.js" "fetch('/pages/Admin/eliminar_administrador.php', {" "fetch('eliminar_administrador.php', {"

# js/Admin/modalVerPedidos.js
Write-Host "Procesando js/Admin/modalVerPedidos.js..."
Replace-FileContent "js/Admin/modalVerPedidos.js" "$.get(""/pages/Admin/pedido_detalle.php"", { id: id }, function (data) {" "$.get(""pedido_detalle.php"", { id: id }, function (data) {"

# js/Admin/tablaAdmin.js
Write-Host "Procesando js/Admin/tablaAdmin.js..."
Replace-FileContent "js/Admin/tablaAdmin.js" "url: ""/pages/Admin/obtener_productos.php?_t="" + new Date().getTime(), // Cache-busting" "url: ""obtener_productos.php?_t="" + new Date().getTime(), // Cache-busting"
...
'@
Replace-FileContent "js/Admin/tablaAdmin.js" "const response = await fetch(""/pages/Admin/actualizar_estado_producto.php"", {" "const response = await fetch(""actualizar_estado_producto.php"", {"
Replace-FileContent "js/Admin/tablaAdmin.js" "const response = await fetch(""/pages/Admin/obtener_metricas.php"");" "const response = await fetch(""obtener_metricas.php"");"

# js/Admin/tablaCategorias.js
Write-Host "Procesando js/Admin/tablaCategorias.js..."
Replace-FileContent "js/Admin/tablaCategorias.js" "url: '/pages/Admin/obtener_categorias.php'," "url: 'obtener_categorias.php',"
Replace-FileContent "js/Admin/tablaCategorias.js" "const url = id ? '/pages/Admin/editar_categoria.php' : '/pages/Admin/agregar_categoria.php';" "const url = id ? 'editar_categoria.php' : 'agregar_categoria.php';"
Replace-FileContent "js/Admin/tablaCategorias.js" "const response = await fetch('/pages/Admin/eliminar_categoria.php', {" "const response = await fetch('eliminar_categoria.php', {"

# js/Admin/tablaFamilias.js
Write-Host "Procesando js/Admin/tablaFamilias.js..."
Replace-FileContent "js/Admin/tablaFamilias.js" "url: '/pages/Admin/obtener_familias.php', // Endpoint para obtener familias" "url: 'obtener_familias.php', // Endpoint para obtener familias"
Replace-FileContent "js/Admin/tablaFamilias.js" "const url = id ? '/pages/Admin/editar_familia.php' : '/pages/Admin/agregar_familia.php';" "const url = id ? 'editar_familia.php' : 'agregar_familia.php';"
Replace-FileContent "js/Admin/tablaFamilias.js" "const response = await fetch('/pages/Admin/eliminar_familia.php', {" "const response = await fetch('eliminar_familia.php', {"

# js/Admin/tablaGestionUsuario.js
Write-Host "Procesando js/Admin/tablaGestionUsuario.js..."
Replace-FileContent "js/Admin/tablaGestionUsuario.js" "url: '/pages/Admin/obtener_usuarios.php'," "url: 'obtener_usuarios.php',"
Replace-FileContent "js/Admin/tablaGestionUsuario.js" "const response = await fetch('/pages/Admin/eliminar_usuario.php', {" "const response = await fetch('eliminar_usuario.php', {"

# js/User/cargarProductosUser.js
Write-Host "Procesando js/User/cargarProductosUser.js..."
Replace-FileContent "js/User/cargarProductosUser.js" "const response = await fetch('/pages/agregar_al_carrito.php', {" "const response = await fetch('agregar_al_carrito.php', {"
Replace-FileContent "js/User/cargarProductosUser.js" "window.location.href = '/pages/login.php';" "window.location.href = 'login.php';"
Replace-FileContent "js/User/cargarProductosUser.js" "const response = await fetch(""/pages/contador_carrito.php"");" "const response = await fetch(""contador_carrito.php"");"
Replace-FileContent "js/User/cargarProductosUser.js" "const response = await fetch(`/pages/obtener_familias_por_categoria.php?categoria_nombre=${categoryName}`);" "const response = await fetch(`obtener_familias_por_categoria.php?categoria_nombre=${categoryName}`);"
Replace-FileContent "js/User/cargarProductosUser.js" "let url = `/pages/obtener_prductos_user.php?categoria=${encodeURIComponent(categoria)}`;" "let url = `obtener_prductos_user.php?categoria=${encodeURIComponent(categoria)}`;"

# js/eliminarProductoCarrito.js
Write-Host "Procesando js/eliminarProductoCarrito.js..."
Replace-FileContent "js/eliminarProductoCarrito.js" "fetch('/pages/Eliminar_Producto_Carrito.php', {" "fetch('Eliminar_Producto_Carrito.php', {"
Replace-FileContent "js/eliminarProductoCarrito.js" "fetch('/pages/Limpiar_Carrito.php', { method: 'POST' })" "fetch('Limpiar_Carrito.php', { method: 'POST' })"
...
Replace-FileContent "pages/Admin/admin.php" "header('Location: /pages/login_admin.php');" "header('Location: ../login_admin.php');"
...
Replace-FileContent "pages/Admin/categorias.php" "header('Location: /pages/login_admin.php');" "header('Location: ../login_admin.php');"
...
Replace-FileContent "pages/Admin/familias.php" "header('Location: /pages/login_admin.php');" "header('Location: ../login_admin.php');"
...
Replace-FileContent "pages/Admin/generador_codigos.php" "header('Location: /pages/login_admin.php');" "header('Location: ../login_admin.php');"
...
<link rel="stylesheet" href="../style/carrito.css">
'@
Replace-FileContent "pages/Carrito.php" 'href="\/"' 'href="index.php"'
Replace-FileContent "pages/Carrito.php" @'
...
Replace-FileContent "pages/login.php" 'header("Location: /");' 'header("Location: index.php");'
...
<link rel="stylesheet" href="../style/perfil.css">
'@
Replace-FileContent "pages/perfilUser.php" 'href="\/"' 'href="index.php"'
Replace-FileContent "pages/perfilUser.php" @'
...
Replace-FileContent "pages/registrar.php" 'header("Refresh: 2; URL=/pages/login.php");' 'header("Refresh: 2; URL=login.php");'
...
Write-Host "Scripts de configuración local creados correctamente."