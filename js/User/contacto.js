document.addEventListener("DOMContentLoaded", () => {
  ...
  const productosHeading = document.querySelector("h2.text-3xl");
  ...
  if (contactoLink) {
    contactoLink.addEventListener("click", (e) => {
      ...
      if (productosHeading) productosHeading.classList.add("hidden");
  ...
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3324.073263522781!2d-70.6576055!3d-34.0370029!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x966347baf26041cd%3A0x85a209dac1ce737a!2sMundo%20Librer%C3%ADa!5e0!3m2!1ses-419!2sar!4v1722382929430!5m2!1ses-419!2sar"
  ...
  document.querySelectorAll(".category-link").forEach((link) => {
    link.addEventListener("click", () => {
      ...
      if (productosHeading) productosHeading.classList.remove("hidden");
    });
  });
});
